...
Private Sub cmd2_Click()
    ...
    ' Mostrar el valor seleccionado para depuración
    MsgBox "Valor ingresado para filtrar: '" & seleccion & "'"

    ' Crear el filtro según la entrada
    If seleccion = "Si" Or seleccion = "No" Then
        filtro = " WHERE j.jue_habi = '" & seleccion & "'" ' Filtrar por 'Sí' o 'No'
    Else
        MsgBox "Por favor, ingrese 'S' para Sí o 'N' para No.", vbExclamation
        filtro = "" ' Si no hay selección válida, no aplicar filtro
    End If

    ' Mostrar el filtro para depuración
...
Sub gridFix()
    ...
    With FGridDatos
        ...
        .Cols = 8  ' Número de columnas a mostrar
